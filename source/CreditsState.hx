...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Psych Engine Team'],
			['SMixels2',		'smixels2',		'Main Creator and Artist/Animator',							'https://gamejolt.com/@SMixels2',	'0094FF'],
			['Ender Funkin',	'ender',		'Main Coder',						'https://twitter.com/EnderFunkin',		'00FFFF'],
