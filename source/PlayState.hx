...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['-1 Star', 0.2], //From 0% to 19%
		['0 Star', 0.4], //From 20% to 39%
		['1 Star', 0.5], //From 40% to 49%
		['1.5 Star', 0.6], //From 50% to 59%
		['2 Star', 0.69], //From 60% to 68%
		['2.5 Star', 0.7], //69%
		['3 Star', 0.8], //From 70% to 79%
		['4 Star', 0.9], //From 80% to 89%
		['5 Star', 1], //From 90% to 99%
		['Holy Shit 5+ STAR?', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
