...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		logoBl.frames = Paths.getSparrowAtlas('anflockin/logoBumpin');
		...
		*/
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				case 1:
					#if PSYCH_WATERMARKS
					createCoolText(['This is mod by'], 15);
					#else
				...
				case 5:
					#if PSYCH_WATERMARKS
					createCoolText(['Creator Angry Birds', 'by'], -40);
					#else
					createCoolText(['In association', 'with'], -40);
					#end
				case 7:
					addMoreText('Rovio', -40);
					ngSpr.visible = true;
				// credTextShit.text += '\nNewgrounds';
				case 8:
					deleteCoolText();
				...
				// credTextShit.text += '\nNight';
				case 15:
					addMoreText('Flockin'); // credTextShit.text += '\nFunkin';
